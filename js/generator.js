...
*/
const MOODS = {
  calm:      { hue: [185, 225], sat: 0.8,  colors: ['#E3EFF3', '#9CC3D5', '#4F7C8A'] },
  energetic: { hue: [0, 40],    sat: 1.15, colors: ['#FFE08A', '#FF7A3D', '#D7263D'] },
  warm:      { hue: [15, 45],   sat: 1.0,  colors: ['#F6E3C6', '#E9A46A', '#B5552C'] },
  elegant:   { hue: [220, 290], sat: 0.7,  colors: ['#1B1B2F', '#C9A227', '#EDE6D6'] },
  natural:   { hue: [80, 150],  sat: 0.85, colors: ['#E4EDD9', '#8A9A5B', '#3E5A3C'] },
...
/*
  ...
  [أساسي 60%، ثانوي 30%، تمييز 10%، إضافي، إضافي]
  h = درجة اللون الأساسية، shift = دوران التناسق، c = دالة تصنع اللون
*/
const STYLE_TEMPLATES = {
  minimal: (h, shift, c) => [c(h, 8, 97), c(h, 25, 18), c(h + shift, 70, 55), c(h, 10, 86), c(h, 12, 55)],

  luxury: (h, shift, c) => [
    c(h, 35, 10),                                                 // خلفية داكنة جداً
    c(40, 35, 93),                                                // كريمي
    shift === 30 ? c(43, 62, 50) : c(h + shift, 55, 42),          // ذهبي أو لون جوهري
    c(h, 30, 22),
    c(h + shift, 40, 32),
  ],

  bold: (h, shift, c) => [c(h, 15, 98), c(h, 50, 12), c(h + shift, 90, 55), c(h, 90, 52), c(h + shift + 60, 85, 60)],
  ...
  earthy: (h, shift, c) => {
    ...
    return [c(38, 30, 92), c(e2 + 40, 20, 36), c(e - 5, 55, 50), c(e + 25, 25, 66), c(e, 30, 24)];
  },

  retro: (h, shift, c) => [c(40, 50, 90), c(h, 40, 45), c(h + shift, 55, 55), c(40, 60, 70), c(h, 20, 25)],
};
